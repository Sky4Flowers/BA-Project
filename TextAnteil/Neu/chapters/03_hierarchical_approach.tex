...
\chapter{Problemdiskussion}\label{chapter:dimensionwise_refinement}
	...
	\section{Umsetzung}
		...
		\subsection{UIAnchor}
			...
			\begin{figure}[htbp]
				...
				\caption{Menü der Hololens \takenFrom{asc_notes}.}
	...
	\section{Evaluierung}
		%- Studie
		%- 13 Teilnehmer
		Um die beschriebene Umsetzung zu evaluieren wurde eine Nutzerstudie durchgeführt, an der dreizehn Freiwillige im Alter zwischen 16 und 26 Jahren teilnahmen. \todo{Altersbereich checken und mehr} 
		...
		\subsection{Studienablauf}
			...
			\todo{Frage/Kommentar zur Umsetztung fehlt noch}
			...
			Die zu bewertenden Elemente wurden so ausgewählt, dass jeweils mindestens zwei Beispiele aus den Prioritätsklassen \term{high}, \term{medium}, \term{low} und zwei kontextabhängige Exemplare bewertet werden.
